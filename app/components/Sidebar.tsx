  ...
  return (
    <div className="bg-indigo-800 text-white h-screen flex flex-col justify-between px-6 w-72">
      ...
      <Menu as="div" className="relative">
        <Menu.Button className={"px-4 py-2 rounded-md border-indigo-500 border-2 w-full hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"}>Account Details</Menu.Button>
        <Transition
          as={Fragment}
